...
const Statescard = ({title,icon,data}:statesCardProps) => {
  return (
    <motion.div whileHover={{y:-10, boxShadow:"0px 15px 30px rgba(0,0,0,0.1)"}} transition={{duration:0.3}} className="p-6 border border-gray-700 rounded-xl shadow-xl cursor-pointer">
